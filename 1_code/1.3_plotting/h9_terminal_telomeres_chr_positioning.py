...
ax_q.set_title("q-arm")
ax_q.set_xticks([20, 10, 0])
ax_q.set_xticklabels(['20', '10', '0'])
ax_q.set_yticks([])
style_xaxis(ax_q)
add_box_border(ax_q)
...
sm.set_array([])
cb = fig.colorbar(sm, ax=[ax_p, ax_q], fraction=0.04, pad=0.02, aspect=40)
...
sm_can.set_array([])
cb = fig.colorbar(sm_can, ax=[ax_p, ax_q], fraction=0.04, pad=0.02, aspect=40)
